...
parser.add_argument('--test_name', type=str, default=f"HE_Flaky_test_{current_time}", help='The base name of the test.')
parser.add_argument('--build_name', type=str, default=f"HE_Flaky_Build_{current_time}", help='The base name of the build.')
