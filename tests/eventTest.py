...
parser.add_argument('--builds', type=int, default=25, help='The number of builds to run.')
parser.add_argument('--parallel', type=int, default=25, help='The maximum number of worker threads.')
# parser.add_argument('--test_name', type=str, default=f"HE_v3_FTD_Test_{current_time}", help='The base name of the test.')
# parser.add_argument('--build_name', type=str, default=f"HE_v3_FTD_Build_aut_{current_time}", help='The base name of the build.')
parser.add_argument('--test_name', type=str, default=f"Event Test Pass", help='The base name of the test.')
parser.add_argument('--build_name', type=str, default=f"Event Build Pass", help='The base name of the build.')
...
parser.add_argument('--error_repeat', type=int, default=0, help='To run the chosen error n number of times')
